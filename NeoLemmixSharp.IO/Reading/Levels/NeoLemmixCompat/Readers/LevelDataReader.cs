...
internal sealed class LevelDataReader : NeoLemmixDataReader
{
    ...
    {
        var id = NxlvReadingHelpers.ParseHex(secondToken);
    ...
    {
        var version = NxlvReadingHelpers.ParseHex(secondToken);
    ...
    {
        _levelData.LevelStyle = new StyleIdentifier(_uniqueStringSet.GetUniqueStringInstance(line[secondTokenIndex..]));
    }
