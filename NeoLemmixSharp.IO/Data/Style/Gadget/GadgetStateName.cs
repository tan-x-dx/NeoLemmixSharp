...
public readonly struct GadgetStateName : IEquatable<GadgetStateName>
{
    ...
    public bool Equals(GadgetStateName other) => string.Equals(_gadgetStateName, other._gadgetStateName, StringComparison.Ordinal);
    ...
    public static implicit operator GadgetStateName(string? gadgetStateName) => new(gadgetStateName);
}
