...
public sealed class TerrainManager
{
        ...
        LevelPosition levelPosition)
    {
        ...
        return pixel.IsSolidToOrientation(lemming.Orientation) ||
               _gadgetManager.HasGadgetOfTypeAtPosition(levelPosition, MetalGrateGadgetInteractionType.Instance);
    }
    ...
    public void SetSolidPixel(LevelPosition pixelToSet, uint color)
    {
        if (PositionOutOfBounds(pixelToSet) ||
            _gadgetManager.HasGadgetOfTypeAtPosition(pixelToSet, MetalGrateGadgetInteractionType.Instance))
            return;
