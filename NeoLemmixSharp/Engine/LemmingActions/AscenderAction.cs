...
public sealed class AscenderAction : LemmingAction
{
    ...
    public override bool UpdateLemming(Lemming lemming)
    {
        ...
        while (dy < 2 &&
               ...
               Terrain.GetPixelData(lemming.Orientation.MoveUp(levelPosition, 1)).IsSolidToLemming(lemming))
        {
            dy++;
